...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $form['email'] = mysqli_real_escape_string($con, $_POST['email']);
    $form['password'] = mysqli_real_escape_string($con, $_POST['password']);
...
$page_content = include_template('login.php', ['form' => $form, 'categories'=> $categories, 'errors' => $errors]);
