     ...
     <div class="container">
		...
		<?php for ($i=0; $i < count($lots); $i++) : ?>
          <li class="lots__item lot">
            ...
            <div class="lot__info">
              ...
              <?php  $lot_id = $lots[$i]['id']; $go_to_lot = "lot.php?id=" . "$lot_id"; ?>
              ...
              <div class="lot__state">
				...
				<?php $classname = ($time_to_end[$i]['feature_finish']) ? "timer--finishing" : ""; ?>
      ...
      <ul class="pagination-list">	   
        <li class="pagination-item pagination-item-prev"><a <?php $page = $cur_page -1; $goto_to_page = "search.php?page=" . "$page";
        ...
        <li class="pagination-item pagination-item-next">
		    <a <?php $page = $cur_page +1; $goto_to_page = "search.php?page=" . "$page"; if ($cur_page < $pages_count) :?>
