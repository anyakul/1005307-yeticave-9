    ...
    <form class="form form--add-lot container <?=$class_form?>"  action="add_lot.php" method="post" enctype="multipart/form-data"> <!-- form--invalid -->
      ...
      <div class="form__container-two">
        ...
        $value_input = (isset($lot['lot-name']))? $lot['lot-name'] : "Введите наимонавание лота ";
        $value_span = (isset($errors['lot-name']))? $errors['lot-name'] : "Введите наименование лота";          
		?>     		
        ...
        $value_span = (isset($errors['category']))? $errors['category'] : "Выберите категорию";          
		?>     		
	  ...
	  <?php $classname =isset($errors['message']) ? "form__item--invalid" : "";		 
        ...
        $value_span = (isset($errors['message']))? $errors['message'] : "Введите описание лота";          
		?>     		
	  ...
	  <?php $classname =isset($errors['image']) ? "form__item--invalid" : "";		 
       ...
       $value_span = (isset($errors['image']))? $errors['image'] . "загрузите снова" : "добавить";          
	   ?>     		
	  ...
	  <?php $classname = (isset($errors['lot-rate'])) ? "form__item--invalid" : "";		 
        ...
        $value_span = (isset($errors['lot-rate']))? $errors['lot-rate'] : "Введите начальную цену";          
		?>     		
      <div class="form__container-three <?=$classname ?>">
        ...
        $value_span = (isset($errors['lot-step'])) ? $errors['lot-step'] : "Введите шаг ставки";          
		?>     		
        ...
        $value_span = (isset($errors['lot-date']))? $errors['lot-date'] : "Введите дату завершения торгов";          
		?>     		
        <div class="form__item <?=$classname ?> ">
