<?php
    ...
    if (isset($_GET['search'])) {  // получен текстовый запрос
        // некоторая защита от SQL-инъекций
        $_SESSION['search'] = addslashes(trim($_GET['search']));
    ...
    $page_content = include_template('search.php', [ 'lots' =>$lots,  'h2_text' => $word_search,  'time_to_end' => $time_to_end,
